...
$sql = "
CREATE TABLE `ims_jc_jingjiren_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `bank_name` varchar(11) NOT NULL DEFAULT '0' COMMENT '银行名称',
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_cash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
...
CREATE TABLE `ims_jc_jingjiren_customer_remarks` (
  ...
  `customer_first` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `customer_name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `customer_phone` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '1',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC
";
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_dic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_dic_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '1',
...
$sql = "
CREATE TABLE `ims_jc_jingjiren_document` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
$sql = "
CREATE TABLE `ims_jc_jingjiren_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `onlyid` varchar(255) DEFAULT NULL COMMENT '唯一标志码',
  `openid` varchar(50) NOT NULL,
  `access_token` varchar(50) DEFAULT '0',
  `access_time` int(11) DEFAULT '0' COMMENT '授权码时效',
  `name` varchar(50) DEFAULT '0' COMMENT '姓名',
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_member_distribution` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  ...
  `level` int(2) NOT NULL DEFAULT '0' COMMENT '等级，1是一级分销。二是二级分销',
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_member_formid` (
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_member_getmoney` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `truename` varchar(255) NOT NULL DEFAULT '' COMMENT '真实姓名',
  `alipay` varchar(255) NOT NULL DEFAULT '0' COMMENT '支付宝号',
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_member_getmoney_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `title` varchar(100) DEFAULT NULL,
  `img` varchar(255) DEFAULT NULL,
  `content` text,
  `look` int(123) NOT NULL DEFAULT '0',
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_process` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  ...
  `content_type` int(11) NOT NULL DEFAULT '1' COMMENT '1:无关金钱/2：涉及金钱',
  `price` int(11) DEFAULT '0' COMMENT '比例',
  `order` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `create_time` int(11) NOT NULL DEFAULT '0',
  `update_time` int(11) NOT NULL DEFAULT '0',
  `is_del` int(11) NOT NULL DEFAULT '0' COMMENT '2，停止了的',
  `state` int(11) NOT NULL DEFAULT '1' COMMENT '1;未开始2：进行中3：已完成',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=553 DEFAULT CHARSET=utf8 COMMENT='流程'
";
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_project` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '1',
  `name` varchar(11) NOT NULL COMMENT '项目名称',
  `subname` varchar(344) DEFAULT NULL COMMENT '副标题',
  `category_id` int(11) NOT NULL COMMENT '类目id',
  `table_id` varchar(255) NOT NULL DEFAULT '0',
  `description` text,
  `slide` varchar(255) NOT NULL DEFAULT '1' COMMENT '轮播图',
  ...
  `vt_price_already` int(255) NOT NULL DEFAULT '0' COMMENT '以发放金额',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='项目'
";
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_project_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_project_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_san` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '1',
  `name` varchar(255) NOT NULL COMMENT '名称',
  `title` varchar(255) NOT NULL COMMENT '名称下边的那段话',
  `url` varchar(255) DEFAULT NULL COMMENT '跳转的链接',
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_sysparams` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  ...
  `is_del` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='系统参数'";
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `task_number` varchar(255) NOT NULL DEFAULT '0' COMMENT '订单编号',
  `uniacid` int(11) NOT NULL DEFAULT '3',
  ...
  `dics_id` text COMMENT '自定义字段name',
  `dics_data` text COMMENT '自定义字段值',
  `state_check` int(11) NOT NULL DEFAULT '1' COMMENT '审核状态 1：审核中/2：审核通过/0：未通过',
  `state_why` varchar(255) DEFAULT NULL COMMENT '审核理由，不通过才有',
  `state_progress` int(11) NOT NULL DEFAULT '0' COMMENT '流程进度 1：洽谈中/2：服务中/3：已完成/4:代传合同，0审核中',
  ...
  `stop_remark` varchar(200) DEFAULT NULL COMMENT '打断备注',
  ...
  `contract_id` varchar(255) NOT NULL DEFAULT '0' COMMENT '合同id',
  `finish_time` varchar(255) NOT NULL DEFAULT '0' COMMENT '签约时间',
  `create_time` int(11) NOT NULL DEFAULT '0',
  `update_time` int(11) NOT NULL DEFAULT '0',
  `is_del` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='任务/订单'
";
pdo_query($sql);

$sql = "
CREATE TABLE `ims_jc_jingjiren_tpmessage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
pdo_query($sql);
$sql = "
CREATE TABLE `ims_jc_jingjiren_upload` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  ...
  `is_del` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=288 DEFAULT CHARSET=utf8 COMMENT='文件'

";
pdo_query($sql);

$sql = "
CREATE TABLE `ims_jc_jingjiren_wallet` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  ...
  `is_del` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='钱包'
";
pdo_query($sql);

$sql="
CREATE TABLE `ims_jc_jingjiren_wallet_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
