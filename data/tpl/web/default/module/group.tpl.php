	...
	<div class="combo-list">
		...
		<table class="table we7-table table-hover vertical-middle">
			...
			<tr >
				...
				<td class="text-center"><span data-toggle="tooltip" data-placement="bottom" title="" data-original-title="小程序应用个数"><?php  echo intval($module_group['wxapp_num'])?></span></td>
			...
			<tr class="collapse bg-light-gray" aria-expanded="true" data-id="toggle-<?php  echo $module_group['id'];?>">
				<td colspan="8">
					...
					<div class="col-sm-11">
						<?php  if(is_array($module_group['xzapp_modules'])) { foreach($module_group['xzapp_modules'] as $xzapp) { ?>
						<div class="col-sm-3 text-left text-over">
							<img src="<?php  echo $xzapp['logo'];?>">
							<a href=""><?php  echo $xzapp['title'];?></a>
						</div>
						<?php  } } ?>
					</div>
				</td>
