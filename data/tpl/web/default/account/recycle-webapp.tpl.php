...
<ul class="we7-page-tab">
	<li><a href="<?php  echo url ('account/manage', array('account_type' => ACCOUNT_TYPE_WEBAPP_NORMAL))?>">PC列表</a></li>
		...
		<li class="active"><a href="<?php  echo url ('account/recycle', array('account_type' => ACCOUNT_TYPE_WEBAPP_NORMAL))?>">PC回收站</a></li>
		<?php  } ?>
...
<script>
	...
	angular.module('accountApp').value('config', {
		...
		links: {
			postRecover: "<?php  echo url('account/recycle/recover', array('type' => ACCOUNT_TYPE_WEBAPP_NORMAL))?>",
			postDel: "<?php  echo url('account/recycle/delete', array('type' => ACCOUNT_TYPE_WEBAPP_NORMAL))?>",
		}
	});
