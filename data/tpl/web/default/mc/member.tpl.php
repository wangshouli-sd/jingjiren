...
<form method="post" class="we7-form" id="form1">
			<table class="table we7-table table-hover vertical-middle">
				...
				<tr>
					...
					<th>手机</th>
					<th >邮箱</th>
					<th class="text-left"><?php  echo $creditnames['credit2']['title'];?>/<?php  echo $creditnames['credit1']['title'];?></th>
					<th >注册时间</th>
				...
				<tr>
					...
					<td class="text-left">
						<span class="label label-primary"><?php  echo $creditnames['credit2']['title'];?>：<?php  echo $li['credit2'];?></span>
						<br>
						<span class="label label-warning"><?php  echo $creditnames['credit1']['title'];?>：<?php  echo $li['credit1'];?></span>
					</td>
...
<form action="./index.php?c=mc&a=member&do=add" method="post" class="form-horizontal" role="form" id="form1">
	<div class="panel panel-info">
		...
		<div class="panel-body we7-padding">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"><?php  echo $creditnames['credit1']['title'];?></label>
				<div class="col-sm-9 col-xs-12">
					<input type="text" name="credit1" value="0" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><?php  echo $creditnames['credit2']['title'];?></label>
				<div class="col-sm-9 col-xs-12">
